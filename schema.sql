...
CREATE TABLE band_description_id (
...
CREATE TABLE band (
	...
	FOREIGN KEY (description_id)
        REFERENCES band_description_id (description_id)
);
...
INSERT INTO band_description_id (commercial_awareness, communicating_and_teamwork, innovation_and_continuous_improvement,
	customer_focus, developing_yourself_and_others, planning_and_organising, job_specific_knowledge)
...
INSERT INTO band (name, school_id, description_id) -- All Bands
VALUES ('Executive', 1, 1), ('Leadership Executive', 1, 2), ('Principal', 1, 3), ('Manager', 2, 4), ('Consultant', 2, 5),
('Senior Associate', 2, 6), ('Associate', 3, 7), ('Trainee', 3, 8), ('Apprentice', 3, 9);
